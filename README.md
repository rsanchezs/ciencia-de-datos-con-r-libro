...
La __Ciencia de Datos__ en una disciplina apasionante que permite analizar datos para extraer conocimiento o un mejor entendimiento de datos en sus diferentes formas. El objetivo principal de <a href=https://leanpub.com/ciencia-de-datos-con-r  target="_blank">Ciencia de Datos con R</a>
...
Este es el __libro en español más completo y exhaustivo__ que encontrarás sobre <a href=https://leanpub.com/ciencia-de-datos-con-r  target="_blank">Ciencia de Datos con R</a>. Perfectamente organizado y metódico, introduce todos los temas de forma sencilla, gradual y 100% práctica.
...
En la segunda parte del libro trataremos las dos tareas de la fase de importar datos.
...
En la tercera parte del libro trataremos las tareas de la fase de exploración de nuestros datos, conocido en inglés como _data wrangling_.
